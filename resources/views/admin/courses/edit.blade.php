                    ...
                    <form method="POST" action="{{ route('courses.update', $course) }}">
                        ...
                        <div class="block mt-4">
                            <label for="is_lab" class="inline-flex items-center">
                                <input id="is_lab" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_lab" value="1" {{ old('is_lab', $course->is_lab) ? 'checked' : '' }}>
